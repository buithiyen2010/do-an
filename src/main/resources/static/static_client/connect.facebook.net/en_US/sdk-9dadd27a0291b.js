/*1617344895,,JIT Construction: v1003560612,en_US*/
...
try {
            ...
            with(this) {
                ...
                __d("fb-error-lite", [], (function(a, b, c, d, e, f) {
                    ...
                    function a(a) {
                        ...
                        b.messageParams = ES(d, "map", !0, function(a) {
                            return String(a)
                        });
                ...
                __d("invariant", ["Env", "fb-error-lite", "sprintf"], (function(a, b, c, d, e, f) {
                    ...
                    function a(a, b) {
                        if (!a) {
                            ...
                            n.messageFormat = c;
                            n.messageParams = ES(e, "map", !0, function(a) {
                                return String(a)
                            });
                ...
                __d("ChunkedRequest", ["Log", "QueryString", "RequestConstants", "sdk.safelyParseResponse", "wrapFunction"], (function(a, b, c, d, e, f) {
                    ...
                    function a(a, c, d, e) {
                        ...
                        c.onerror = function(a) {
                            a.responseText ? e(b("sdk.safelyParseResponse")(a.responseText, null, a.status)) : e({
                                error: babelHelpers["extends"]({}, b("RequestConstants").PARSE_ERROR_TEMPLATE, {
                                    status: a.status
                                })
                            })
                ...
                __d("ApiClient", ["ApiBatcher", "ApiClientUtils", "Assert", "CORSRequest", "ChunkedRequest", "JSONPRequest", "Log", "ObservableMixin", "QueryString", "UrlMap", "flattenObject"], (function(a, b, c, d, e, f) {
                    var g, h, i, j = [],
                ...
                __d("sdk.Auth", ["Log", "ObservableMixin", "QueryString", "UrlMap", "sdk.Cookie", "sdk.Impressions", "sdk.Runtime", "sdk.Scribe", "sdk.SignedRequest", "sdk.UA", "sdk.URI", "sdk.WebStorage", "sdk.feature", "sdk.getContextType"], (function(a, b, c, d, e, f) {
                    var g = "fblst_",
                        h = "fbssls_",
                        i = "fblo_",
                        j = 365 * 24 * 60 * 60 * 1e3,
                        ...
                        n = 114,
                        o = 117,
                        p, q, r = /^https?:\/\/([\w\.]+)?\.facebook\.com\/?/,
                        s = new(b("ObservableMixin"))();
                    b("sdk.Runtime").subscribe("AccessToken.change", function(a) {
                        !a && b("sdk.Runtime").getLoginStatus() === "connected" && s.getLoginStatus(null, !0)
                    });
                    ...
                    function t(a, c, d) {
                        ...
                        } else b("sdk.Runtime").getUseCookie() && b("sdk.Cookie").clearSignedRequestCookie(), b("sdk.Runtime").getUseLocalStorage() && z();
                        ...
                        (j || e) && s.inform("logout", g);
                        (i || e) && s.inform("login", g);
                        m && s.inform("authresponse.change", g);
                        f && s.inform("status.change", g);
                    ...
                    function c(a, c, d, e) {
                        return function(d) {
                            if (d && d.access_token) {
                                ...
                                asset_scopes: ES("JSON", "parse", !1, d.asset_scopes)
                            }, c = y(c, d), A(), f = "connected", t(c, f), x(e)) : d && d.error === "access_denied" ? (B(), f = "unknown", t(null, f)) : d && d.result && (A(), c = d.result.authResponse);
                            if (a) {
                                f = {
                                    authResponse: c,
                                    status: b("sdk.Runtime").getLoginStatus()
                    ...
                    function y(a, c) {
                        ...
                        c.base_domain != null && v(c.base_domain);
                        w(c.graph_domain);
                    ...
                    function E(a) {
                        ...
                        var c = b("sdk.Cookie").getRaw(i) === "y",
                            d = null,
                            e = !1;
                        if (b("sdk.Runtime").getLoginStatus() !== "connected" && (document.referrer === "" || r.test(document.referrer))) {
                        ...
                        var l = (e = d) != null ? e : f;
                        window.location.protocol !== "https:" && C(a);
                    ...
                    function G(a, c, d) {
                        switch (c) {
                            case "connected":
                                ...
                                d.base_domain != null && v(d.base_domain);
                                w(d.graph_domain);
                    ...
                    function d(c, d, a) {
                        ...
                        function g() {
                            ...
                            d && (d.open("GET", f.toString(), !0), d.withCredentials = !0, d.onreadystatechange = function() {
                                if (d.readyState === 4) {
                                    ...
                                    if (d.status === 200) {
                                        G(c, (f = d.getResponseHeader("fb-s")) != null ? f : "unknown", (f = d.getResponseHeader("fb-ar")) != null ? f : "{}")
                                    } else H(c, d.status, a)
                                }
                            }, d.send())
                        }
                        ...
                        function h() {
                            window.fetch(f.toString(), {
                                ...
                                if (b.status === 200) {
                                    var d;
                                    G(c, (d = b.headers.get("fb-s")) != null ? d : "unknown", (d = b.headers.get("fb-ar")) != null ? d : "{}")
                                } else H(c, b.status, a)
                            })["catch"](function(b) {
                                return H(c, 0, a)
                            })
                    ...
                    function f(a, c) {
                        ...
                        d = b("sdk.Runtime").getLoginStatus() !== "connected" && r.test(document.referrer) && ES(location.hash, "indexOf", !0, "cb=") > -1;
                            ...
                            if (d) {
                                ...
                                if (d != null) try {
                                    ...
                                    if (d != null && d.expiresAt != null && d.expiresAt > ES("Date", "now", !1)) {
                                        var e;
                                        I = "loaded";
                                        t(d.authResponse, (e = d.status) != null ? e : "unknown", !0);
                                        q = window.setTimeout(function() {
                                            E(function() {})
                        ...
                        if (!c)
                            ...
                            a && s.subscribe("FB.loginStatus", a);
                            return
                        }
                        a && s.subscribe("FB.loginStatus", a);
                        I = "loading";
                        d = function(a) {
                            I = "loaded", s.inform("FB.loginStatus", a), s.clearSubscribers("FB.loginStatus")
                        };
                        E(d)
                    }
                ...
                __d("sdk.modFeatureCheck", ["JSSDKConfig"], (function(a, b, c, d, e, f) {
                    ...
                    function a(a, c, d) {
                        ...
                        if (b("JSSDKConfig").features && a in b("JSSDKConfig").features) {
                            ...
                            if (typeof e === "object" && ES("Array", "isArray", !1, e)) return ES(c, "some", !0, function(a) {
                                return ES(e, "some", !0, function(b) {
                                    return a % b === 0
                                })
                            })
                        }
                ...
                __d("sdk.UIServer", ["Log", "QueryString", "UrlMap", "createObjectFrom", "flattenObject", "guid", "insertIframe", "resolveURI", "sdk.Auth", "sdk.Content", "sdk.DOM", "sdk.Dialog", "sdk.Event", "sdk.Extensions", "sdk.Frictionless", "sdk.Impressions", "sdk.Native", "sdk.RPC", "sdk.Runtime", "sdk.Scribe", "sdk.UA", "sdk.XD", "sdk.api", "sdk.fbt", "sdk.feature", "sdk.getContextType", "sdk.modFeatureCheck", "sdk.openMessenger"], (function(a, b, c, d, e, f) {
                    ...
                    var o = {
                        ...
                        popup: function(a) {
                            ...
                            f = d.join(",");
                            a.post ? (g = window.open("about:blank", a.id, f), g && (o.setLoadedNode(a, g, "popup"), b("sdk.Content").submitToTarget({
                                url: a.url,
                                target: a.id,
                                params: a.params
                            }))) : (g = window.open(a.url, a.id, f), g && o.setLoadedNode(a, g, "popup"));
                            if (!g) {
                ...
                __d("legacy:fb.xfbml", ["Assert", "FB", "XFBML", "sdk.Event", "sdk.domReady", "wrapFunction"], (function(a, b, c, d, e, f) {
                    b("FB").provide("XFBML", {
                        parse: function(a) {
                ...
                __d("sdk.XFBML.Quote", ["DOMEventListener", "IframePlugin", "UnicodeUtils", "containsNode", "sdk.DOM", "sdk.UA", "sdk.XD", "sdk.feature"], (function(a, b, c, d, e, f) {
                    "use strict";
                    var g, h = "fb-quotable",
                        i = 155,
                        j = 70,
                ...
                __d("legacy:fb.xfbml.plugins", ["IframePlugin", "PluginConfig", "PluginTags", "XFBML", "sdk.XFBML.Comments", "sdk.XFBML.CommentsCount", "sdk.XFBML.LWIAdsCreation", "sdk.XFBML.LWIAdsInsights", "sdk.XFBML.LoginButton", "sdk.XFBML.Quote", "sdk.XFBML.Save", "sdk.XFBML.ShareButton", "sdk.XFBML.Video", "sdk.feature"], (function(a, b, c, d, e, f) {
                    var g = {
    ...
    new Image().src = "https:\/\/www.facebook.com\/" + 'common/scribe_endpoint.php?c=jssdk_error&m=' + encodeURIComponent('{"error":"LOAD", "extra": {"name":"' + e.name + '","line":"' + (e.lineNumber || e.line) + '","script":"' + (e.fileName || e.sourceURL || e.script) + '","stack":"' + (e.stackTrace || e.stack) + '","revision":"1003560612","namespace":"FB","message":"' + e.message + '"}}');
}