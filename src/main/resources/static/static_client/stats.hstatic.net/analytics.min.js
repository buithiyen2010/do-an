(function(f) {
    ...
    return function() {
            ...
            (function() {
                ...
                var data = {
                    ...
                    options_GA: {
                        ...
                        enhancedEcommerce: HaravanAnalytics.enhancedEcommerce || false,
                ...
                HaravanAnalytics = window.HaravanAnalytics;
                HaravanAnalytics.init = function() {
                    this.registerOnload(function(data) {
                        try {
                            if (HaravanAnalytics.ga) HaravanAnalytics.ga_eventOnload(data);
                            if (HaravanAnalytics.fb) HaravanAnalytics.fb_eventOnload(data);
                            HaravanAnalytics.segment_eventOnload(data)
                        } catch (e) {}
                    });
                    this.registerFormSubmit(function(data) {
                        try {
                            if (HaravanAnalytics.ga) HaravanAnalytics.ga_eventFormSubmit(data);
                            if (HaravanAnalytics.fb) HaravanAnalytics.fb_eventFormSubmit(data)
                        } catch (e) {}
                    });
                    document.addEventListener("DOMContentLoaded", function(event) {
                        HaravanAnalytics.registerAjax(function(data) {
                            try {
                                if (HaravanAnalytics.ga) HaravanAnalytics.ga_eventAjax(data);
                                if (HaravanAnalytics.fb) HaravanAnalytics.fb_eventAjax(data);
                                HaravanAnalytics.segment_eventAjax(data)
                            } catch (e) {}
                        })
                    })
                };
                HaravanAnalytics.registerOnload = function(callback) {
                    var pageType = HaravanAnalytics.meta.page.pageType;
                    if (!pageType) {
                        return
                    }
                    data.pageType = pageType;
                    if (pageType == "product") {
                        var product = HaravanAnalytics.meta.product;
                        if (product) {
                            data.properties.id = product.id;
                            if (product.selected_or_first_available_variant) {
                                data.properties.name = product.selected_or_first_available_variant.title;
                                data.properties.variantId = product.selected_or_first_available_variant.id;
                                data.properties.variant = product.selected_or_first_available_variant.variant_title;
                                data.properties.price = product.selected_or_first_available_variant.price / 100;
                                data.properties.sku = product.selected_or_first_available_variant.sku
                            } else {
                                data.properties.title = product.title;
                                data.properties.price = product.price / 100
                            }
                            data.properties.vendor = product.vendor;
                            data.properties.type = product.type;
                            data.properties.event = "Viewed Product"
                        }
                    } else if (pageType == "searchresults") {
                        var keySearch = HaravanAnalytics.meta.search;
                        if (keySearch) {
                            data.properties.keySearch = keySearch.query
                        }
                    } else if (pageType == "thankyou") {
                        if (!Haravan.checkout) {
                            return
                        }
                        var arrItemsCart = Haravan.checkout;
                        var arrProductId = [];
                        var quantity = 0;
                        arrItemsCart.line_items.forEach(function(v) {
                            var t = {
                                id: v.product_id,
                            ...
                            data.products.push(t);
                            if (arrProductId.includes(v.product_id) == false) {
                                arrProductId.push(v.product_id)
                            }
                            quantity += v.quantity
                        });
                        data.properties.arrProductId = arrProductId;
                        data.properties.coupon = arrItemsCart.discount.code;
                        data.properties.orderId = arrItemsCart.order_number;
                        data.properties.shipping = arrItemsCart.shipping_rate.price;
                        data.properties.subtotal_price = arrItemsCart.subtotal_price;
                        data.properties.total_price = arrItemsCart.total_price;
                        data.properties.quantity = quantity;
                        data.properties.event = "Completed Order";
                        if (readCookie("tracked_start_checkout") == arrItemsCart.token) {
                            setCookie(true, "tracked_start_checkout", "")
                        } else {
                            data.properties.cartToken = true
                        }
                    } else if (pageType == "checkout") {
                        var orderlist = HaravanAnalytics.meta.cart;
                        var pageInfo = HaravanAnalytics.meta.page;
                        if (orderlist && pageInfo) {
                            var arrProductId = [];
                            orderlist.products.forEach(function(v) {
                                var t = {
                                    id: v.productId,
                                ...
                                data.products.push(t);
                                if (arrProductId.includes(v.productId) == false) {
                                    arrProductId.push(v.productId)
                                }
                            });
                            data.properties.arrProductId = arrProductId;
                            data.properties.quantity = orderlist.item_count;
                            data.properties.total_price = orderlist.total_price / 100;
                            data.properties.event = "Viewed Checkout";
                            if (readCookie("tracked_start_checkout") != pageInfo.resourceId || readCookie("tracked_start_checkout") == "" || readCookie("tracked_start_checkout") == null || readCookie("tracked_start_checkout") == "undefined") {
                                setCookie(true, "tracked_start_checkout", pageInfo.resourceId)
                            } else {
                                data.properties.cartToken = true
                            }
                        }
                ...
                HaravanAnalytics.registerFormSubmit = function(callback) {
                    var data = {};
                ...
                HaravanAnalytics.registerAjax = function(callback) {
                    if (!$) return;
                    $(document).ajaxSuccess(function(event, xhr, settings) {
                        if (settings != undefined && settings.url.indexOf("/cart/add") != -1) {
                            if (xhr != undefined && xhr.responseJSON) {
                                var productTrack = xhr.responseJSON;
                                var variant_title = "";
                                var quantity = getQuantityAjax(settings.data);
                                productTrack.variant_options.forEach(function(v) {
                                    variant_title = variant_title + v + " / "
                                });
                                data.pageType = "ajaxCart";
                                var t = data.properties;
                                t.id = productTrack.product_id;
                                t.variantId = productTrack.variant_id;
                                t.name = productTrack.title + " - " + variant_title.slice(0, -3);
                                t.variant = variant_title.slice(0, -3);
                                t.category = "";
                                t.quantity = quantity;
                                t.price = productTrack.price / 100;
                                t.sku = productTrack.sku;
                                t.vendor = productTrack.vendor;
                                t.type = "";
                                t.event = "Added Product";
                                callback(data);
                                data.options_GA.enhancedEcommerce && HaravanAnalytics.enhancedEcommerce(data)
                            }
                        }
                    })
                };
                HaravanAnalytics.ga_eventOnload = function(data) {
                    if (!HaravanAnalytics.AutoTrack) return;
                    if (data) {
                        if (data.options_GA.enhancedEcommerce) {
                            data.options_GA.doubleClick && window.ga("require", "displayfeatures");
                            data.options_GA.enhancedLinkAttribution && window.ga("require", "linkid");
                            data.options_GA.anonymizeIp && window.ga("set", "anonymizeIp", data.options_GA.anonymizeIp);
                            data.options_GA.enhancedEcommerce && HaravanAnalytics.enhancedEcommerce(data)
                        }
                    }
                };
                HaravanAnalytics.ga_eventFormSubmit = function(data) {
                    if (!HaravanAnalytics.AutoTrack) return;
                    if (data) {
                        ga(function(tracker) {
                            var linkerParam = tracker.get("linkerParam");
                            document.cookie = "_haravan_ga=" + linkerParam + "; " + "path=/"
                        })
                    }
                };
                HaravanAnalytics.ga_eventAjax = function(data) {};
                HaravanAnalytics.ga_pageView = function(data, e) {
                    if (!HaravanAnalytics.AutoTrack) return;
                    var t = e.path,
                        r = data.options_GA.includeSearch && e.search && (t += e.search) || t,
                        n = e.title;
                    var o = {
                        page: r,
                        title: n
                ...
                HaravanAnalytics.enhancedEcommerce = function(e) {
                    if (!HaravanAnalytics.AutoTrack) return;

                    function loadEnhancedEcommerce(e) {
                        var t = e.options_GA;
                        t.enhancedEcommerceLoaded || (window.ga("require", "ec"), t.enhancedEcommerceLoaded = true);
                        window.ga("set", "&cu", e.properties.currency)
                    }

                    function trackInternal(e) {
                        var t = e.properties,
                            n = {
                                eventAction: t.event,
                    ...
                    function enhancedEcommerceTrackProduct(e) {
                        var t = {
                        ...
                        e.coupon && (t.coupon = e.coupon), window.ga("ec:addProduct", t)
                    }

                    function pushEnhancedEcommerce(e) {
                        var t = e.properties;
                    ...
                    function enhancedEcommerceProductAction(e, t) {
                        enhancedEcommerceTrackProduct(e);
                        window.ga("ec:setAction", t)
                    }

                    function viewedProductEnhanced(e) {
                        var t = e.properties;
                        loadEnhancedEcommerce(e);
                        enhancedEcommerceProductAction(t, "detail");
                        pushEnhancedEcommerce(e)
                    }

                    function addedProductEnhanced(e) {
                        var t = e.properties;
                        loadEnhancedEcommerce(e);
                        enhancedEcommerceProductAction(t, "add");
                        pushEnhancedEcommerce(e)
                    }

                    function startedOrderEnhanced(e) {
                        var t = e.products;
                        loadEnhancedEcommerce(e);
                        for (var a = 0; a < e.products.length; a++) {
                            enhancedEcommerceTrackProduct(t[a])
                        }
                    ...
                    function completedOrderEnhanced(e) {
                        var t = e.properties,
                            r = t.total_price.toString() || t.subtotal_price.toString() || "",
                            n = t.orderId.toString(),
                            o = e.products || [];
                        if (n) {
                            loadEnhancedEcommerce(e);
                            for (var a = 0; a < o.length; a++) {
                                enhancedEcommerceTrackProduct(o[a])
                            }
                    ...
                    if (e.pageType == "product") {
                        viewedProductEnhanced(e)
                    } else if (e.pageType == "ajaxCart") {
                        addedProductEnhanced(e)
                    } else if (e.pageType == "checkout") {
                        if (e.properties.cartToken) {
                            trackInternal(e, "Viewed Checkout - Contact information Page")
                        } else {
                            startedOrderEnhanced(e)
                        }
                    } else if (e.pageType == "thankyou") {
                        if (e.properties.cartToken) {
                            trackInternal(e, "Viewed Orders - Thank You Page")
                        } else {
                            completedOrderEnhanced(e)
                        }
                    }
                };
                HaravanAnalytics.fb_eventOnload = function(data) {
                    if (!HaravanAnalytics.AutoTrack) return;
                    if (data) {
                        if (data.pageType == "product") {
                            fbq("track", "ViewContent", {
                                content_ids: [data.properties.id],
                                content_name: data.properties.name,
                                content_type: "product_group",
                                value: data.properties.price,
                                currency: data.properties.currency
                            })
                        } else if (data.pageType == "searchresults") {
                            fbq("track", "Search", {
                                search_string: data.properties.keySearch
                            })
                        } else if (data.pageType == "thankyou") {
                            fbq("track", "AddPaymentInfo", {
                                value: data.properties.total_price,
                                currency: data.properties.currency
                            });
                            fbq("track", "Purchase", {
                                content_ids: data.properties.arrProductId,
                                content_type: "product_group",
                                value: data.properties.subtotal_price,
                                num_items: data.properties.quantity,
                                currency: data.properties.currency
                            })
                        } else if (data.pageType == "checkout" && !data.properties.cartToken) {
                ...
                HaravanAnalytics.fb_eventFormSubmit = function(data) {};
                HaravanAnalytics.fb_eventAjax = function(data) {
                    if (!HaravanAnalytics.AutoTrack) return;
                    if (data) {
                        fbq("track", "AddToCart", {
                            content_ids: [data.properties.id],
                ...
                HaravanAnalytics.segment_eventOnload = function(data) {
                    if (data) {
                        if (data.pageType == "product") {
                            hrv_analytics.track("ViewProduct", HaravanAnalytics.meta.product)
                        } else if (data.pageType == "searchresults") {
                            hrv_analytics.track("Search", HaravanAnalytics.meta.search)
                        } else if (data.pageType == "thankyou") {
                            hrv_analytics.track("Purchase", Haravan.checkout)
                        } else if (data.pageType == "checkout") {
                            hrv_analytics.track("InitiateCheckout", HaravanAnalytics.meta.cart)
                        }
                    }
                };
                HaravanAnalytics.segment_eventAjax = function(data) {
                    if (data) {
                        hrv_analytics.track("AddToCart", data.properties)
                    }
                };
                hrv_analytics.ready(function() {
                    if (!HaravanAnalytics.meta || !HaravanAnalytics.meta.page || !HaravanAnalytics.meta.page.pageType) return;
                    var user = hrv_analytics.user();
                    var customerId = HaravanAnalytics.meta.page.customerId;
                    var q = querystring.parse(window.location.search);
                    if (q.ref_f4l) {
                        hrv_analytics.identify({
                            ref_f4l: q.ref_f4l
                        })
                    }
                    if (HaravanAnalytics.meta.page.pageType == "thankyou") customerId = Haravan.checkout.customer_id;
                    if (user && user.id()) {
                        if (customerId && customerId != user.id()) hrv_analytics.identify(customerId)
                    } else {
                        if (customerId) hrv_analytics.identify(customerId)
                    }
                    if (HaravanAnalytics.meta.page.resourceType == "checkout") {
                        hrv_analytics.identify({
                            checkoutid: HaravanAnalytics.meta.page.resourceId
                        })
                    }
                });
                ...
                function setCookie(permanent, cookieName, cookieValue) {
                    var today = new Date;
                    var increment = permanent ? 1e3 * 60 * 60 * 24 * 365 : 1e3 * 60 * 60 * 7;
                ...
                function pageDefaults() {
                    var e = window.location.href,
                        t = e.indexOf("?");
                    return e = -1 === t ? "" : e.slice(t), t = e.indexOf("#"), e = -1 === t ? e : e.slice(0, t), e = "?" === e ? "" : e, {
                ...
                function canonical() {
                    for (var e = document.getElementsByTagName("link"), t = 0; t < e.length; t++) {
                        var r = e[t];
                        if ("canonical" === r.getAttribute("rel")) return r.getAttribute("href")
                    }
                    return ""
                }
                ...
                function url() {
                    var e = canonical();
                    if (e) return e.indexOf("?") > 0 ? e : e + window.location.search;
                    var t = window.location.href,
                        r = t.indexOf("#");
                    return -1 === r ? t : t.slice(0, r)
                }
                try {
                    HaravanAnalytics.init()
                } catch (e) {}
            })()
        }, {
            "component-querystring": 72
        }],
        2: [function(require, module, exports) {
            ...
            var Segment = exports = module.exports = integration("haravan.com").option("apiKey", "").option("apiHost", "stats.hstatic.net/v1").option("crossDomainIdServers", []).option("deleteCrossDomainId", false).option("saveCrossDomainIdInLocalStorage", true).option("retryQueue", true).option("addBundledMetadata", false).option("unbundledIntegrations", []);
            ...
            Segment.prototype.initialize = function() {
                ...
                if (this.options.retryQueue) {
                    this._lsqueue = new Queue("haravan", queueOptions, function(elem, done) {
                        var item = elem;
            ...
            "@segment/localstorage-retry": 45,
            "@segment/protocol": 54,
            "@segment/send-json": 55,
            "@segment/top-domain": 57,
            "@segment/utm-params": 58,
            "component-clone": 62,
            "component-cookie": 63,
            json3: 85,
            uuid: 120,
        ...
        3: [function(require, module, exports) {
            (function(global) {
                ...
                var hrv_analytics = require("@segment/analytics.js-core");
                var Integrations = require("./integrations");
                var hrv_analyticsq = global.hrv_analytics || [];
                module.exports = exports = hrv_analytics;
                hrv_analytics.require = require;
                exports.VERSION = require("../package.json").version;
                Object.keys(Integrations).forEach(function(name) {
                    hrv_analytics.use(Integrations[name])
                });
                var apiHost = "stats.hstatic.net/v1";
                hrv_analytics.start = function(apiKey) {
                    var settings = {
                        "haravan.com": {
                            apiHost: apiHost,
                            apiKey: apiKey
                    ...
                    hrv_analytics.initialize(settings, {
                    ...
                    require("./haravan-analytics")
                };
                while (hrv_analyticsq && hrv_analyticsq.length > 0) {
                    var args = hrv_analyticsq.shift();
                    var method = args.shift();
                    if (typeof hrv_analytics[method] === "function") {
                        hrv_analytics[method].apply(hrv_analytics, args)
                    }
                }
                hrv_analyticsq = null;
                global.hrv_analytics = hrv_analytics
        ...
        30: [function(require, module, exports) {
            module.exports = {
                _args: [
                    ["git+https://github.com/vinhhrv/analytics.js-core.git", "/Users/vdvinh/Source/Haravan/analytics.js/js"]
                ],
                _from: "git+https://github.com/vinhhrv/analytics.js-core.git",
                _id: "@segment/analytics.js-core@git+https://github.com/vinhhrv/analytics.js-core.git#2b15dd35bdba1c56b0c1c2b59f7467d8a173d564",
                _inBundle: false,
                _integrity: "",
                ...
                _requested: {
                    type: "git",
                    raw: "git+https://github.com/vinhhrv/analytics.js-core.git",
                    rawSpec: "git+https://github.com/vinhhrv/analytics.js-core.git",
                    saveSpec: "git+https://github.com/vinhhrv/analytics.js-core.git",
                    fetchSpec: "https://github.com/vinhhrv/analytics.js-core.git",
                    gitCommittish: null
                },
                _requiredBy: ["/"],
                _resolved: "git+https://github.com/vinhhrv/analytics.js-core.git#2b15dd35bdba1c56b0c1c2b59f7467d8a173d564",
                _spec: "git+https://github.com/vinhhrv/analytics.js-core.git",
                _where: "/Users/vdvinh/Source/Haravan/analytics.js/js",
                author: {
                    name: "Segment",
        ...
        83: [function(require, module, exports) {
            ...
            module.exports.extend = function(additionalFilters) {
                list = list.concat(additionalFilters.filter(included));
                update()
            };
        ...
        123: [function(require, module, exports) {
            module.exports = {
                ...
                dependencies: {
                    "@segment/analytics.js-core": "git+https://github.com/vinhhrv/analytics.js-core.git",
